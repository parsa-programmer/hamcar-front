  ...
  <aside class="profile__sidebar mobile-card">
    <ul class="sidebar__menu">
      ...
      <template v-else>
        ...
        <li :class="['sidebar__item']" @click="$router.push('/account/exhibition/verify')" v-if="
        ...
        " style="color: #02ada6">
          <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke="#02ADA6" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
            <path
        ...
        <li :class="[
          ...
          <account-icons-adverts :width="20" :height="21" hash-color="var(--color-black)" />
          آگهی های من
        </li>
        <li :class="[
          'sidebar__item',
        ...
        <li :class="[
          ...
          <account-icons-comment :width="20" :height="21" hash-color="var(--color-black)" />
          پیام های من
