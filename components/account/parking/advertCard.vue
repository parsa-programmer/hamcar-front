<template>
  <div>
    <div class="advert" v-if="isMobile == false">
      ...
      <div class="advert__body">
        ...
        <div class="advert__footer mt-2">
          ...
          <div class="actions">
            <button @click="useNardeban" class="nardeban__btn">
              <icons-check :width="18" :height="18" hash-color="white" />
              فعال سازی
            </button>
          </div>
        </div>
    ...
    <account-parking-adver-mobile-card
      :advert="advert"
      v-else
      :show-price="showPrice"
    >
      <template #actions>
        <p @click="useNardeban" class="color-blue font-5">
          فعالسازی
        </p>
      </template>
    </account-parking-adver-mobile-card>
...
const expireDate = new Date(advert.inActiveDate);
