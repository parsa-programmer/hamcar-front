<template>
  <div :class="['bottom__sheet', { 'bottom__sheet-close': isOpen == false }]">
    <Transition enter-active-class="animate__animated  animate__fadeIn animate__faster"
      ...
      <div class="bottom__sheet-background" v-if="isOpen" @click.self="() => (isOpen = false)"></div>
    </Transition>
    <div class="sheet__wrapper" @click="openSheet">
      ...
      <div class="botton__sheet-content">
        ...
        <template v-else>
              ...
              <nuxt-link class="item-icon" to="/account/exhibition/verify">
                <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    stroke="#02ADA6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path
          ...
          <div class="item">
            <a class="item-icon" @click="logout">
