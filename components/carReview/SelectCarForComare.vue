<template>
  <div class="modal" :style="[{ display: modelValue ? 'block' : 'none' }]">
    <div class="modal-content">
      ...
      <div class="row mobile__bottons" style="flex-grow: 1;display: none">
          <h-button :loading="isLoading" :disabled="isLoading" @click="search" style="flex-grow: 3;height: 3rem;">
          جستوجو
        </h-button>
        <h-button color="error" @click="close" style="flex-grow: 1;height: 3rem;">بستن</h-button>
      </div>
