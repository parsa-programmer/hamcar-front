    ...
    <div class="container">
      <nav class="nav">
        <div class="nav__wrapper">
          <div class="nav__logo">
            <nuxt-link to="/">
              <img src="/img/Persian-HamCar-Logo.png" alt="همکار" class="nav__img nav__img--fa" />
            </nuxt-link>
            <nuxt-link to="/">
              <img src="/img/English-HamCar-Logo.png" alt="همکار" class="nav__img nav__img--en" />
            </nuxt-link>
          </div>
          <ul class="nav__menu">
            ...
            <li class="nav__item has__menu">
              <a href="#" class="nav__link title">موتور سیکلت</a>
              <ul>
                <li>
                  <nuxt-link to="/sell/motorcycle">ثبت آگهی متور سیکلت</nuxt-link>
                </li>
                <li>
                  <nuxt-link to="/motorcycle">خرید متور سیکلت</nuxt-link>
                </li>
              </ul>
            </li>
            <li class="nav__item has__menu">
        ...
        <template v-if="showMobileIcons">
          <div :class="['nav__register', { 'disable-element': showSearchIcon }]">
            <client-only fallbackTag="div">
              ...
              <template v-else>
                ...
                <template v-else>
                  <nuxt-link to="/account/exhibition" class="
                      btn btn-transparent
                      nav__register-link nav__register-link--login
          ...
          <div class="nav__icons-wrapper" v-if="showSearchIcon">
            <div class="nav__icon nav__icon--bars-icon">
              <svg width="20" height="15" viewBox="0 0 20 15" fill="none" @click="isOpenSideBar = true">
                <path d="M1.42969 1.42847H18.574M1.42969 7.14323H18.574M1.42969 12.858H18.574"
                  stroke="var(--color-black)" stroke-width="1.50012" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </div>
          ...
          <div class="nav__icon nav__icon--bars-icon" v-else>
            <svg width="20" height="15" viewBox="0 0 20 15" fill="none" @click="isOpenSideBar = true">
              <path d="M1.42969 1.42847H18.574M1.42969 7.14323H18.574M1.42969 12.858H18.574" stroke="var(--color-black)"
                stroke-width="1.50012" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </div>
        </template>
        <template v-else>
      ...
      <div class="header__bottom" v-if="showSearchBar">
        <div class="input-group">
          <input type="text" class="form-control light-border header__input" placeholder="جستجو میان همه آگهی ها..." />
          <svg class="input-icon" width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path
              ...
              stroke="#C6C7CC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M19.1326 19.1304L16.8203 16.8182" stroke="#C6C7CC" stroke-width="1.5" stroke-linecap="round"
