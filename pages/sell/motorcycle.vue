<template>
  <div>
    ...
    <Head>
      ...
      <Title>ثبت آگهی فروش موتورسیکلت شما</Title>
    ...
    <section class="breadcrumb">
      ...
      <a class="breadcrumb__item breadcrumb__item--active">ثبت آگهی موتورسیکلت </a>
    </section>
    <section class="registration" v-if="pending == false">
      <div class="registration__head">
        <h1 class="registration__title">ثبت آگهی فروش موتورسیکلت شما</h1>
        <search-advert />
      </div>
      <div class="registration__content">
        <register-advert-steps />
        <div class="registration__container">
          <register-advert-step-one is-motor />
          <Transition name="custom-classes2" enter-active-class="animate__animated animate__fadeInUp "
            leave-active-class="animate__animated animate__bounceOutRight">
            <register-advert-motorcycle-step-two v-if="store.currentStep >= 2" />
          </Transition>
